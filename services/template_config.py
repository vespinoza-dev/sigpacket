...
def _standard_sig_fields(start_order):
    ...
    return [
        ...
        _f("email", "field", "Email Address", enabled=False, order=start_order + 9),
        _f("phone", "field", "Phone Number", enabled=False, order=start_order + 10),
        _f("cc_email", "field", "CC Email Address", enabled=False, order=start_order + 11),
        _f("address", "field", "Mailing Address", enabled=False, order=start_order + 12),
        _f("city_state_zip", "field", "City/State/ZIP", enabled=False, order=start_order + 13),
    ]
...
DEFAULT_CONFIGS = {
    ...
    "stock_purchase_agreement": {
        ...
        "fields": [
            ...
            _f("email", "field", "Email Address", enabled=False, order=10),
            _f("phone", "field", "Phone Number", enabled=False, order=11),
            _f("cc_email", "field", "CC Email Address", enabled=False, order=12),
            _f("address", "field", "Mailing Address", enabled=False, order=13),
            _f("city_state_zip", "field", "City/State/ZIP", enabled=False, order=14),
        ],
    ...
    "certificate_of_incorporation": {
        ...
        "fields": [
            ...
            _f("email", "field", "Email", enabled=False, order=11),
            _f("phone", "field", "Phone", enabled=False, order=12),
            _f("cc_email", "field", "CC Email", enabled=False, order=13),
            _f("address", "field", "Address", enabled=False, order=14),
            _f("city_state_zip", "field", "City/State/ZIP", enabled=False, order=15),
        ],
